...
export type TransactionCategory =
  $Result.DefaultSelection<Prisma.$TransactionCategoryPayload>;
/**
 * Model User
 *
 */
...
> {
   ...
   * ```
   */
  get transactionCategory(): Prisma.TransactionCategoryDelegate<
    ExtArgs,
    ClientOptions
  >;
...
export namespace Prisma {
  ...
  */
      ...
      TransactionCategory: {
        ...
        operations: {
          ...
          count: {
            ...
            result:
              | $Utils.Optional<TransactionCategoryCountAggregateOutputType>
              | number;
          };
        };
      };
  ...
  > = {
    Transaction?:
      | boolean
      | TransactionCategoryCountOutputTypeCountTransactionArgs;
  };
   ...
   * TransactionCategoryCountOutputType without action
   */
  export type TransactionCategoryCountOutputTypeCountTransactionArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
  ...
  export type GetTransactionCategoryAggregateType<
    T extends TransactionCategoryAggregateArgs,
  > = {
    [P in keyof T & keyof AggregateTransactionCategory]: P extends
      | "_count"
      | "count"
      ? T[P] extends true
        ? number
  ...
  > = {
    ...
    orderBy?:
      ...
      | TransactionCategoryOrderByWithAggregationInput[];
    by:
      | TransactionCategoryScalarFieldEnum[]
      | TransactionCategoryScalarFieldEnum;
  ...
  type GetTransactionCategoryGroupByPayload<
    T extends TransactionCategoryGroupByArgs,
  > = Prisma.PrismaPromise<
    Array<
      PickEnumerable<TransactionCategoryGroupByOutputType, T["by"]> & {
        [P in keyof T &
          keyof TransactionCategoryGroupByOutputType]: P extends "_count"
          ? T[P] extends boolean
            ? number
  ...
  type TransactionCategoryCountArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = Omit<
    TransactionCategoryFindManyArgs,
    "select" | "include" | "distinct" | "omit"
  > & {
  ...
  > {
    ...
    createManyAndReturn<T extends TransactionCategoryCreateManyAndReturnArgs>(
      args?: SelectSubset<
        T,
        TransactionCategoryCreateManyAndReturnArgs<ExtArgs>
      >,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$TransactionCategoryPayload<ExtArgs>,
    ...
    updateManyAndReturn<T extends TransactionCategoryUpdateManyAndReturnArgs>(
      args: SelectSubset<
        T,
        TransactionCategoryUpdateManyAndReturnArgs<ExtArgs>
      >,
    ): Prisma.PrismaPromise<
      $Result.GetResult<
        Prisma.$TransactionCategoryPayload<ExtArgs>,
    ...
    count<T extends TransactionCategoryCountArgs>(
      ...
      T extends $Utils.Record<"select", any>
        ? T["select"] extends true
          ...
          : GetScalarType<
              T["select"],
              TransactionCategoryCountAggregateOutputType
            >
        : number
    >;
    ...
    >(
      args: SubsetIntersection<T, TransactionCategoryGroupByArgs, OrderByArg> &
        InputErrors,
    ): {} extends InputErrors
  ...
  > extends Prisma.PrismaPromise<T> {
    readonly [Symbol.toStringTag]: "PrismaPromise";
    Transaction<T extends TransactionCategory$TransactionArgs<ExtArgs> = {}>(
      args?: Subset<T, TransactionCategory$TransactionArgs<ExtArgs>>,
    ): Prisma.PrismaPromise<
      | $Result.GetResult<
          Prisma.$TransactionPayload<ExtArgs>,
          T,
  ...
  > = {
    ...
    data: XOR<
      ...
      TransactionCategoryUncheckedCreateInput
    >;
  };
  ...
  > = {
     ...
     */
    data:
      | TransactionCategoryCreateManyInput
      | TransactionCategoryCreateManyInput[];
    skipDuplicates?: boolean;
  };
  ...
  > = {
    ...
    data: XOR<
      ...
      TransactionCategoryUncheckedUpdateInput
    >;
    /**
   ...
   */
  export type TransactionCategory$TransactionArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Transaction
   ...
   * User.Transaction
   */
  export type User$TransactionArgs<
    ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs,
  > = {
    /**
     * Select specific fields to fetch from the Transaction
  ...
  export type TransactionWhereInput = {
    ...
    category?: XOR<
      TransactionCategoryScalarRelationFilter,
  ...
  export type UserCreateNestedOneWithoutTransactionInput = {
    create?: XOR<
      ...
      UserUncheckedCreateWithoutTransactionInput
    >;
  ...
  export type TransactionCategoryCreateNestedOneWithoutTransactionInput = {
    create?: XOR<
      TransactionCategoryCreateWithoutTransactionInput,
      TransactionCategoryUncheckedCreateWithoutTransactionInput
    >;
  ...
  export type TransactionCategoryUpdateOneRequiredWithoutTransactionNestedInput =
    {
      ...
      update?: XOR<
        XOR<
          TransactionCategoryUpdateToOneWithWhereWithoutTransactionInput,
          TransactionCategoryUpdateWithoutTransactionInput
        >,
        TransactionCategoryUncheckedUpdateWithoutTransactionInput
      >;
    };
